...
public class YetAnotherImportTsv {
    ...
    private static class TsvTokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            if (columns.length == 1) {
                ...
                // TODO: Design new rowKey to evenly load data into 10 regions.
                String originalKey = columns[ROW_KEY_INDEX];
                int prefix = Math.abs(originalKey.hashCode()) % 10;
                String rowKey = String.format("%02d|%s", prefix, originalKey);
    ...
    private static class HBaseTableReducer extends
         ...
         */
        final String[] COLUMN_HEADER = {"neighborhood", "business_id", "hours", "postal_code", "address",
                "attributes", "categories", "city", "review_count", "name", "longitude", "state", "stars", "latitude", "open"};
    ...
    public static void main(String[] args) throws Exception {
        String inputPath = "/input/yelp_academic_dataset_businesses_no_header.tsv";
        String tableName = "business";

        Configuration conf = HBaseConfiguration.create();
        // TODO: update the configuration
        String zkAddr = "10.0.0.12,10.0.0.13,10.0.0.9";
